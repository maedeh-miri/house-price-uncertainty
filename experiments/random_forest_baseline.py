"""Evaluate the Random Forest baseline using training-only cross-validation."""
...
FOLD_RESULTS_PATH = RESULTS_DIRECTORY / "random_forest_baseline_cv_folds.csv"
SUMMARY_PATH = RESULTS_DIRECTORY / "random_forest_baseline_cv_summary.json"
...
def main() -> None:
    """Run the training-only Random Forest baseline experiment."""
